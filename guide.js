(()=>{
  ...
  const sections=[
    ...
    },
    {
      ...
      html:'<dl class="guide-dl"><dt>Timer</dt><dd>Captures hesitation as well as correctness.</dd><dt>Response</dt><dd>Fast / hesitant / prompted / no concept.</dd><dt>Prompt used</dt><dd>Records how much support was needed.</dd><dt>K/C/Q/P/F/R/A</dt><dd>Records the likely reason an answer broke down.</dd><dt>Suggested next step</dt><dd>A cue for what to do next; it is not a score.</dd><dt>Other observation</dt><dd>Optional tags such as self-corrected, guessed, explained clearly, needed re-reading or attention drift.</dd><dt>Add note</dt><dd>Capture a contextual observation against the current area.</dd></dl>'
    },
    {
    ...
    {
      id:'stats',title:'Where the learning statistics live',
      html:'<p>Use <strong>Stats</strong> in the top bar to open Sai’s learning dashboard. It combines the question-level evidence collected in Focus and the Evidence plan into visual summaries: response quality, speed, prompting, confidence, K/C/Q/P/F/R/A breakdowns, activity over time, learning-cycle progress and skill-level patterns.</p><p>These are evidence summaries, not a single score. The dashboard is most useful for seeing patterns across repeated sessions.</p>'
    },
    {
